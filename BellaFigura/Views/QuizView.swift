...
//var questionImage : String = "covidMenu"
...
//                            .stroke(Color( colorLiteral(red: 0.9294117647, green: 0.431372549, blue: 0.3411764706, alpha: 1)), lineWidth: 3)
//                )
//            Text(questionText)
//        }
...
//
//    var body: some View {
//        if falseAnswer == false && trueAnswer == false {​​​​​​​​Button(action: {
//
...
//        }​​​​​​​​)
//        }
//        if falseAnswer == true && trueAnswer == false {​​​​​​​​Button(action: {
////inserire funzione che dia sbagliato o corretto
//
//        }​​​​​​​​, label: {
//            ZStack {
//                RoundedRectangle(cornerRadius: 13)
//                    .frame(height: 58.0)
//                    .foregroundColor(Color( colorLiteral(red: 0.8745098039, green: 0.2470588235, blue: 0.2470588235, alpha: 1)))
//                    .overlay(RoundedRectangle(cornerRadius: 13)
//                                .stroke(Color( colorLiteral(red: 0.9294117647, green: 0.431372549, blue: 0.3411764706, alpha: 1)), lineWidth: 3))
//                Text(answerText)
//                    .foregroundColor(.black)
...
//        }​​​​​​​​)
//        }
//        if falseAnswer == false && trueAnswer == true {​​​​​​​​Button(action: {
////inserire funzione che dia sbagliato o corretto
//        }​​​​​​​​, label: {
//            ZStack {
//                RoundedRectangle(cornerRadius: 13)
//                    .frame(height: 58.0)
//                    .foregroundColor(Color( colorLiteral(red: 0.6941176471, green: 0.8823529412, blue: 0.2980392157, alpha: 1)))
//                    .overlay(RoundedRectangle(cornerRadius: 13)
//                                .stroke(Color( colorLiteral(red: 0.9294117647, green: 0.431372549, blue: 0.3411764706, alpha: 1)), lineWidth: 3))
//                Text(answerText)
//                    .foregroundColor(.black)
